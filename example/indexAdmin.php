...
<head>
   ...
   <title>[ADMIN] ECS Load Track Data</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="bg-light sticky-top container-fluid">
    ...
    <div id="toolbar" class="select" style="margin: 0;">
      ...
      <span style="display:inline-block;"><input type="date" class="form-control" id="myDatePicker" onchange="applyFilter()"/></span>
      ...
      data-id-field="id">
        <thead class="thead-light" >
          <tr>
			...
			<th data-field="ai_judge" data-sortable="true">AI Judgement</th>
            <th data-field="confirmation" 
                  ...
                  data-editable-url="php/update.php"
